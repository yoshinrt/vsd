...
Height:330*Scale,
// 自車インジケータ
IndicatorSize:	10 * Scale,		// サイズ
IndicatorColor:	0x0080FF,		// 色
		
// 地図更新間隔 前回地図更新時から指定秒以上経過し，かつ指定距離以上移動した場合のみ地図を更新します
UpdateTime:33,// [ミリ秒]
UpdateDistance:	1,// [ピクセル]
}
...
function Draw(){
//画面左上にGoogle Map表示
Vsd.DrawRect(0,0*Scale,370*Scale,410*Scale,0xE66000000,DRAW_FILL);
Vsd.DrawTextAlign(20*Scale,40*Scale,ALIGN_LEFT|ALIGN_BOTTOM,"Google Maps",FontA,0x55CCCCCC)
Vsd.DrawTextAlign(350*Scale,40*Scale,ALIGN_RIGHT|ALIGN_BOTTOM,"?GPS",FontD,0xFF9933)
