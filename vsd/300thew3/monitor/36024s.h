/************************************************************************/
/*      H8/36024 Series Include File                       Ver 2.0      */
/************************************************************************/
struct st_sci3_3 {                                      /* struct SCI3  */
                 union {                                /* SMR          */
                 ...
                 union {                                /* SMCR         */
                       ...
                       struct {                         /*  Bit  Access */
                              unsigned char        :6;  /*              */
                              unsigned char TXD_3  :1;  /*    TXD_3     */
                              unsigned char MSTS3_3:1;  /*    MSTS3_3   */
                              }      BIT;               /*              */
                       }        SMCR;                   /*              */
};                                                      /*              */
...
#define SCI3_3  (*(volatile struct st_sci3_3*)0xF600)   /* SCI3_3Address*/
